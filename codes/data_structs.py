# -*- coding: utf-8 -*-
"""
Created on Fri Apr 19 16:25:56 2021
...
class Vocabulary(object):
    ...
    def __init__(self, init_from_file=None, max_length=140):
        ...
        for char in self.vocab:
            value = self.vocab[char]
            self.vocab[char] = value+1
        self.vocab[' ']=0
...
# define list[ H, C, N, O, F, P, S, Cl, Br, I ]
def filter_mol(mol, max_heavy_atoms=50, min_heavy_atoms=10, element_list=[1,6,7,8,9,15,16,17,35,53]):
...
def construct_vocabulary(smiles_list,voc_path):
